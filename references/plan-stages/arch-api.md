...
>
> Next steps:
> - **Implement:** Run `/fellowship:build` to scaffold controllers and tests from this spec.
> - **Schema:** Run `/fellowship:plan --arch schema` to design the database schema for these resources.
> - **Diagram:** Run `/fellowship:plan --arch diagram` to visualize the API architecture.
