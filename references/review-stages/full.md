...
**Agent 1: Code Quality** (`agents/code-quality.md`)
...
**Agent 2: Security** (`agents/security.md`)
- Focus: vulnerabilities with >80% confidence of real exploitation potential
- Model tier: Opus
- Tool access: Read, Glob, Grep, Bash (read-only git/gh commands only)

**Agent 3: Accessibility** (`agents/accessibility.md`)
...
After all three agents return, pass their combined output to the deduplication synthesizer (`agents/dedup-synthesizer.md`).
