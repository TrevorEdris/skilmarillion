---
description: Slice-by-slice TDD execution. Accepts a spec or impl-details file and drives RED-GREEN-REFACTOR per slice.
argument-hint: "[spec-or-impl-details path]"
allowed-tools:
  - Read
  - Write
  - Edit
