---
description: Produce a prioritized migration plan as independently shippable specs ordered by coupling analysis and git hotspot data
argument-hint: "[legacy-path] [target-path]"
allowed-tools:
  - Read
  - Write
  - Glob
...
Assemble the ordered migration units into a ROADMAP.md following the same structure as `/plan:roadmap` output.
